...
class ContourDetection(PipelineProcessor):
    ...
    def __init__(self, bg_subtractor, min_contour_width=30, min_contour_height=30, save_image=False, image_dir='images'):
...
class VehicleCounter(PipelineProcessor):
    ...
    def __init__(self, exit_masks=[], path_size=10, max_dst=60, x_weight=1.0, y_weight=1.0):
